...
Click to enter with pointer lock. W/S or up/down drive and brake/reverse, A/D or left/right steer, R transforms, Shift boosts or runs; in robot form WASD and the arrows move in camera space and Space jumps. Escape releases pointer lock. Normal play has no HUD.
