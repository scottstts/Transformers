...
const DRAW_CUT: CombatMove = {
  ...
  keys: {
    ...
    hipX: [[0.12, 0.06], [0.4, -0.08], [0.62, -0.04], [1.0, 0]],
    hipYaw: [[0.12, 14], [0.26, 6], [0.4, -16], [0.56, -22], [1.0, -6]],
    hipPitch: [[0.12, 6], [0.42, 10], [1.0, 4]],
    spineZ: [[0.15, 10], [0.44, -10], [0.6, -14], [1.0, -4]],
    chestZ: [[0.18, 24], [0.32, 10], [0.48, -26], [0.66, -34], [1.0, -10]],
...
const DASH: CombatMove = {
  ...
  cues: [
    ...
    { t: 0.3, cue: 'weapon-in', value: 0.18 },
    ...
    { t: 1.4, cue: 'weapon-out', value: 0.24 },
  ],
}
