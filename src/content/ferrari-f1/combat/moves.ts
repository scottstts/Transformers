...
const JAB: CombatMove = {
  ...
  keys: {
    ...
    hipYaw: [[0.1, 6], [0.2, -9], [0.5, -4]],
    spineZ: [[0.1, 3], [0.2, -5], [0.5, -2]],
    chestZ: [[0.1, 8], [0.2, -12], [0.5, -6]],
    chestX: [[0.2, 5], [0.5, 3]],
    headZ: [[0.1, -8], [0.2, 14], [0.5, 7]],
    'L.az': [[0.1, 12], [0.2, 2], [0.3, 2], [0.5, 4]],
    'L.el': [[0.1, -28], [0.2, 10], [0.3, 7], [0.5, -24]],
    'L.reach': [[0.1, 0.44], [0.2, 0.98], [0.3, 0.9], [0.5, 0.5]],
    ...
    advance: [[0.1, 0], [0.22, 0.3], [0.5, 0.34]],
  },
  steps: [{ side: 'L', t0: 0.03, t1: 0.17, to: [0.4, 0.42], yaw: 6, lift: 0.12 }],
...
const ROUNDHOUSE: CombatMove = {
  ...
  keys: {
    ...
    spineZ: [[0.34, -18], [0.5, -20], [0.8, -4]],
    chestZ: [[0.12, 6], [0.34, -24], [0.5, -26], [0.8, -6]],
    ...
    advance: [[0.2, 0.05], [0.5, 0.22], [0.8, 0.3]],
  },
  steps: [
    // the support foot pivots on its ball as the hips come round
    { side: 'L', t0: 0.08, t1: 0.3, to: [0.38, 0.1], yaw: -70, lift: 0.02 },
    { side: 'R', t0: 0.12, t1: 0.66, to: [-0.34, 0.34], yaw: -10, via: [0.05, 1.05, 1.75], viaYaw: -80, point: 40 },
    { side: 'L', t0: 0.66, t1: 0.82, to: [0.38, 0.2], yaw: 0, lift: 0.04 },
  ],
...
const DRAW_CUT: CombatMove = {
  ...
  keys: {
    ...
    advance: [[0.2, 0.0], [0.46, 0.66], [0.8, 0.76]],
  },
  steps: [{ side: 'R', t0: 0.2, t1: 0.42, to: [-0.4, 0.78], yaw: -12, lift: 0.18 }],
  cues: [
    { t: 0.03, cue: 'servo', value: 0.3 },
    { t: 0.12, cue: 'weapon-in', value: 0.22 },
...
const DASH: CombatMove = {
  ...
  keys: {
    ...
    hipPitch: [[0.3, 18], [0.5, 30], [0.62, 22], [0.9, 12], [1.5, 4]],
    hipYaw: [[0.3, 20], [0.5, 10], [0.62, -16], [1.0, -16], [1.5, 6], [1.9, 2]],
    spineX: [[0.3, 6], [0.5, 10], [0.9, 4]],
    spineZ: [[0.3, 10], [0.5, 6], [0.62, -14], [1.0, -16], [1.5, 4]],
    chestZ: [[0.3, 22], [0.5, 16], [0.62, -26], [1.0, -24], [1.5, 8], [1.9, 2]],
    chestX: [[0.3, 6], [0.5, 12], [0.9, 6]],
    ...
    'w.y': [[0.3, -0.3], [0.5, -0.28], [0.56, 0.5], [0.62, 0.6], [1.0, 0.6], [1.3, 0.62], [1.45, 0.3], [1.9, 0.22]],
    'w.z': [[0.3, -0.5], [0.5, -0.45], [0.56, -0.1], [0.62, -0.05], [1.0, -0.1], [1.3, -0.05], [1.45, -0.55], [1.9, -0.6]],
    ...
    advance: [[0.3, -0.15], [0.36, 0.2], [0.6, 8.6], [0.75, 9.9], [1.0, 10.3]],
  },
  steps: [
